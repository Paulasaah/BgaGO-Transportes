                ...
                <tr>
                    <td style="padding:0 16px;">
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="background:#ffffff;border-radius:12px;overflow:hidden;">
                            <tr>
                                <td bgcolor="#1d4ed8" style="padding:20px;color:#ffffff;font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif;">
                            ...
                            <tr>
                                <td style="padding:24px;font-family:Arial, Helvetica, sans-serif;color:#111;">
                                    <div style="font-size:22px;font-weight:700;margin:0 0 16px;">Tu reserva fue creada</div>
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;">
                                        ...
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Vehículo</td>
                                            <td style="padding:6px 0;color:#111;">{{ $reservation->vehicle->placa ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Sede</td>
                                            <td style="padding:6px 0;color:#111;">{{ $reservation->branch->nombre ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Inicio</td>
                                            <td style="padding:6px 0;color:#111;">{{ $reservation->fecha_inicio?->format('Y-m-d H:i') }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Fin</td>
                                            <td style="padding:6px 0;color:#111;">{{ $reservation->fecha_fin?->format('Y-m-d H:i') }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Total</td>
                                            <td style="padding:6px 0;color:#111;">${{ number_format($reservation->monto_final, 0, ',', '.') }}</td>
                                        </tr>
                                    </table>
