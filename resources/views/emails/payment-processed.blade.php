                ...
                <tr>
                    <td style="padding:0 16px;">
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="background:#ffffff;border-radius:12px;overflow:hidden;">
                            <tr>
                                <td bgcolor="#16a34a" style="padding:20px;color:#ffffff;font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif;">
                            ...
                            <tr>
                                <td style="padding:24px;font-family:Arial, Helvetica, sans-serif;color:#111;">
                                    <div style="font-size:22px;font-weight:700;margin:0 0 16px;">Tu pago fue procesado</div>
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;">
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Monto</td>
                                            <td style="padding:6px 0;color:#111;">${{ number_format($payment->monto, 0, ',', '.') }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Referencia</td>
                                            <td style="padding:6px 0;color:#111;">{{ $payment->referencia_externa ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Reserva</td>
                                            <td style="padding:6px 0;color:#111;">{{ $payment->reservation?->codigo ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <td width="35%" style="padding:6px 0;color:#555;">Fecha</td>
                                            <td style="padding:6px 0;color:#111;">{{ $payment->fecha_aprobacion?->format('Y-m-d H:i') }}</td>
                                        </tr>
                                    </table>
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-top:16px;">
                                        <tr>
                                            <td align="left" bgcolor="#1d4ed8" style="border-radius:8px;">
                                                <a href="{{ rtrim(config('app.url'), '/') }}/catalog/my-reservations" target="_blank" style="display:inline-block;padding:12px 18px;color:#ffffff;text-decoration:none;font-weight:700;font-family:Arial, Helvetica, sans-serif;">Ver mi reserva</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
