<x-layouts.public>
    <div class="py-24 min-h-screen bg-gradient-to-br from-white via-blue-50 to-blue-100 dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-800 overflow-hidden">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="rounded-2xl ring-1 ring-zinc-200/70 dark:ring-white/10 bg-white/70 dark:bg-white/5 backdrop-blur p-6 sticky top-6">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <a href="{{ route('catalog.index') }}" class="mt-4 inline-block text-blue-600 hover:text-blue-700" wire:navigate>
                                    Ver catálogo
                                </a>
                            </div>
                        @endif
                ...
                <div class="lg:col-span-2">
                    <div class="rounded-2xl ring-1 ring-zinc-200/70 dark:ring-white/10 bg-white/70 dark:bg-white/5 backdrop-blur overflow-hidden">
                        <div class="p-6">
                            <div class="flex items-start justify-between mb-4">
                                <div>
                                    <h2 class="text-2xl font-bold text-zinc-900 dark:text-white">Método de Pago</h2>
                                    <p class="text-sm text-zinc-600 dark:text-zinc-400">Por favor ingresa tu método de pago</p>
                                </div>
                                <span class="text-xs text-zinc-500">Paso 3 de 4</span>
                            </div>
                        ...
                        <div class="p-8">
                            ...
                            @else
                                <div class="text-center py-12">
                                    ...
                                    <a href="{{ route('catalog.index') }}" wire:navigate class="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors">
                    ...
                    <div class="mt-6 grid md:grid-cols-3 gap-4">
                        <div class="rounded-lg p-4 ring-1 ring-zinc-200/70 dark:ring-white/10 bg-white/70 dark:bg-white/5 backdrop-blur text-center">
