#!/bin/bash
# ==========================================================
# 🚀 Test Script API BgaGO - VERSIÓN 2 (Segura y Mejorada)
# ==========================================================
set -u -o pipefail
...
"curl -L -X POST $URL/api/payments/1/approve \
-H 'Accept: application/json' -H 'Authorization: Bearer $ADMIN_TOKEN' \
...
"curl -L -X POST $URL/api/deliveries/1/start -H 'Accept: application/json' -H 'Authorization: Bearer $CONDUCTOR_TOKEN'"
test_request "Completar entrega" \
"curl -L -X POST $URL/api/deliveries/1/complete \
...
"curl -L -X GET $URL/api/deliveries/1/track -H 'Accept: application/json' -H 'Authorization: Bearer $CONDUCTOR_TOKEN'"
separator
